...
) -> Optional[Union[Any, ExternallylinkedworkitemsSingleGetResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ExternallylinkedworkitemsSingleGetResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ExternallylinkedworkitemsSingleGetResponse]
    """
