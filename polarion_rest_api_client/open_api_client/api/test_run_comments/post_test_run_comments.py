...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/projects/{projectId}/testruns/{testRunId}/comments".format(
...
) -> Optional[Union[Any, TestrunCommentsListPostResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, TestrunCommentsListPostResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, TestrunCommentsListPostResponse]
    """
