...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/projects/{projectId}/testruns/{testRunId}/comments/{commentId}".format(
...
) -> Optional[Union[Any, TestrunCommentsSingleGetResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, TestrunCommentsSingleGetResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, TestrunCommentsSingleGetResponse]
    """
