...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/projects/{projectId}/testruns/{testRunId}/testparameters/{testParamId}".format(
...
) -> Optional[Union[Any, TestparametersSingleGetResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, TestparametersSingleGetResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, TestparametersSingleGetResponse]
    """
