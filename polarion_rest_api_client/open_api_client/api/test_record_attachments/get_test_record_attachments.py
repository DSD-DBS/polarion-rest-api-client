...
) -> Optional[Union[Any, TestrecordAttachmentsListGetResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, TestrecordAttachmentsListGetResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, TestrecordAttachmentsListGetResponse]
    """
