...
) -> Optional[Union[Any, FeatureselectionsSingleGetResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, FeatureselectionsSingleGetResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, FeatureselectionsSingleGetResponse]
    """
