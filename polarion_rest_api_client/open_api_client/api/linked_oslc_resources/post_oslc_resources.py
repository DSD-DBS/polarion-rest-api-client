...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/projects/{projectId}/workitems/{workItemId}/linkedoslcresources".format(
...
) -> Optional[Union[Any, LinkedoslcresourcesListPostResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, LinkedoslcresourcesListPostResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, LinkedoslcresourcesListPostResponse]
    """
