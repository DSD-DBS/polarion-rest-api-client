...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/projects/{projectId}/testruns/{testRunId}/testrecords/{testCaseProjectId}/{testCaseId}/{iteration}/testparameters".format(
...
) -> Optional[Union[Any, TestparametersListPostResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, TestparametersListPostResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, TestparametersListPostResponse]
    """
