...
class WorkitemsSinglePatchRequestDataRelationshipsCategoriesDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        workitems_single_patch_request_data_relationships_categories_data_item = cls(
            type=type,
            id=id,
        )

        workitems_single_patch_request_data_relationships_categories_data_item.additional_properties = (
            d
        )
        return workitems_single_patch_request_data_relationships_categories_data_item
