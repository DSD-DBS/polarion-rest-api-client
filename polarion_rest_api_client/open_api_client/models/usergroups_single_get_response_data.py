...
class UsergroupsSingleGetResponseData:
    ...
    attributes: Union[
        Unset, "UsergroupsSingleGetResponseDataAttributes"
    ] = UNSET
    relationships: Union[
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        usergroups_single_get_response_data = cls(
            type=type,
            id=id,
            revision=revision,
        ...
        usergroups_single_get_response_data.additional_properties = d
        return usergroups_single_get_response_data
