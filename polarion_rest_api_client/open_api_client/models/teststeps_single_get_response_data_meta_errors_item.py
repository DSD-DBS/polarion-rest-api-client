...
class TeststepsSingleGetResponseDataMetaErrorsItem:
    ...
    Attributes:
        ...
        source (Union[Unset, TeststepsSingleGetResponseDataMetaErrorsItemSource]):
    ...
    source: Union[
        Unset, "TeststepsSingleGetResponseDataMetaErrorsItemSource"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        teststeps_single_get_response_data_meta_errors_item_obj.additional_properties = (
            d
        )
