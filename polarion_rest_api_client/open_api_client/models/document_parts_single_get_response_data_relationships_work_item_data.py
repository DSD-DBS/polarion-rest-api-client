...
class DocumentPartsSingleGetResponseDataRelationshipsWorkItemData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        document_parts_single_get_response_data_relationships_work_item_data = cls(
            type=type,
            id=id,
            revision=revision,
        )

        document_parts_single_get_response_data_relationships_work_item_data.additional_properties = (
            d
        )
        return document_parts_single_get_response_data_relationships_work_item_data
