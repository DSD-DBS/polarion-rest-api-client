...
class TestrunsSingleGetResponseDataAttributesHomePageContent:
    """
    Attributes:
        type_ (Union[Unset, TestrunsSingleGetResponseDataAttributesHomePageContentType]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testruns_single_get_response_data_attributes_home_page_content_obj.additional_properties = (
            d
        )
        return (
            testruns_single_get_response_data_attributes_home_page_content_obj
