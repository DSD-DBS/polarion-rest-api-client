...
class CollectionsListDeleteRequestDataItem:
    """
    Attributes:
        type (Union[Unset, CollectionsListDeleteRequestDataItemType]):
        id (Union[Unset, str]):  Example: MyProjectId/MyCollectionId.
    """

    type: Union[Unset, CollectionsListDeleteRequestDataItemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = CollectionsListDeleteRequestDataItemType(_type)
