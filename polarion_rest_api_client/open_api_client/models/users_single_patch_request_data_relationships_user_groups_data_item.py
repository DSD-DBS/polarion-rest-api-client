...
class UsersSinglePatchRequestDataRelationshipsUserGroupsDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        users_single_patch_request_data_relationships_user_groups_data_item = (
            cls(
                type=type,
                id=id,
            )
        ...
        users_single_patch_request_data_relationships_user_groups_data_item.additional_properties = (
            d
        )
        return (
            users_single_patch_request_data_relationships_user_groups_data_item
