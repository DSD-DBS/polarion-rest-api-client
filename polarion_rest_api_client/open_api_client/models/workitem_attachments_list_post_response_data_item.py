...
class WorkitemAttachmentsListPostResponseDataItem:
    ...
    links: Union[
        Unset, "WorkitemAttachmentsListPostResponseDataItemLinks"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        workitem_attachments_list_post_response_data_item = cls(
            type=type,
            id=id,
            links=links,
        )

        workitem_attachments_list_post_response_data_item.additional_properties = (
            d
        )
        return workitem_attachments_list_post_response_data_item
