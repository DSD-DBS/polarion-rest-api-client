...
class CollectionsListGetResponseDataItem:
    """
    Attributes:
        type (Union[Unset, CollectionsListGetResponseDataItemType]):
    ...
    type: Union[Unset, CollectionsListGetResponseDataItemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = CollectionsListGetResponseDataItemType(_type)
