...
class WorkitemsListPostRequestDataItemAttributesDescription:
    """
    Attributes:
        type_ (Union[Unset, WorkitemsListPostRequestDataItemAttributesDescriptionType]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_list_post_request_data_item_attributes_description_obj.additional_properties = (
            d
        )
