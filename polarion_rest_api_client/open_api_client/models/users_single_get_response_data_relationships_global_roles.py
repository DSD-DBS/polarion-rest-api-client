...
class UsersSingleGetResponseDataRelationshipsGlobalRoles:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        users_single_get_response_data_relationships_global_roles = cls(
            data=data,
            meta=meta,
        )

        users_single_get_response_data_relationships_global_roles.additional_properties = (
            d
        )
        return users_single_get_response_data_relationships_global_roles
