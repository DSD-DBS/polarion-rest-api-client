...
class WorkitemAttachmentsSingleGetResponseDataLinks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        workitem_attachments_single_get_response_data_links = cls(
            self_=self_,
            content=content,
        )

        workitem_attachments_single_get_response_data_links.additional_properties = (
            d
        )
        return workitem_attachments_single_get_response_data_links
