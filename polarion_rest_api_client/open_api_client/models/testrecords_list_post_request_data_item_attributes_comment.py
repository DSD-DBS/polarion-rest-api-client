...
class TestrecordsListPostRequestDataItemAttributesComment:
    """
    Attributes:
        type_ (Union[Unset, TestrecordsListPostRequestDataItemAttributesCommentType]):
        value (Union[Unset, str]):  Example: My text value.
    """

    type_: Union[
        Unset, TestrecordsListPostRequestDataItemAttributesCommentType
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrecords_list_post_request_data_item_attributes_comment_obj.additional_properties = (
            d
        )
