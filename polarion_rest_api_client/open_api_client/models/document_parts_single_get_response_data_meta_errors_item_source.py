...
class DocumentPartsSingleGetResponseDataMetaErrorsItemSource:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        document_parts_single_get_response_data_meta_errors_item_source = cls(
            pointer=pointer,
            parameter=parameter,
        )

        document_parts_single_get_response_data_meta_errors_item_source.additional_properties = (
            d
        )
        return document_parts_single_get_response_data_meta_errors_item_source
