...
class WorkitemsListGetResponseDataItemLinks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        workitems_list_get_response_data_item_links = cls(
            self_=self_,
            portal=portal,
        )

        workitems_list_get_response_data_item_links.additional_properties = d
        return workitems_list_get_response_data_item_links
