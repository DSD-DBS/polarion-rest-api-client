...
class DocumentPartsListPostRequestDataItemRelationshipsNextPartData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = DocumentPartsListPostRequestDataItemRelationshipsNextPartDataType(
                _type
            )

        id = d.pop("id", UNSET)

        document_parts_list_post_request_data_item_relationships_next_part_data = cls(
            type=type,
            id=id,
        )

        document_parts_list_post_request_data_item_relationships_next_part_data.additional_properties = (
            d
        )
        return document_parts_list_post_request_data_item_relationships_next_part_data
