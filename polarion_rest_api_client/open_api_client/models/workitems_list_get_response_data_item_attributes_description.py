...
class WorkitemsListGetResponseDataItemAttributesDescription:
    """
    Attributes:
        type_ (Union[Unset, WorkitemsListGetResponseDataItemAttributesDescriptionType]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_list_get_response_data_item_attributes_description_obj.additional_properties = (
            d
        )
