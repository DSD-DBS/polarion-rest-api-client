...
class DocumentCommentsListPostRequestDataItem:
    ...
    type: Union[Unset, DocumentCommentsListPostRequestDataItemType] = UNSET
    attributes: Union[
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = DocumentCommentsListPostRequestDataItemType(_type)
        ...
        document_comments_list_post_request_data_item = cls(
            type=type,
            attributes=attributes,
            relationships=relationships,
        )

        document_comments_list_post_request_data_item.additional_properties = d
        return document_comments_list_post_request_data_item
