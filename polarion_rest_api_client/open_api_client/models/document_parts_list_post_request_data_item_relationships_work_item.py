...
class DocumentPartsListPostRequestDataItemRelationshipsWorkItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        document_parts_list_post_request_data_item_relationships_work_item = (
            cls(
                data=data,
            )
        )

        document_parts_list_post_request_data_item_relationships_work_item.additional_properties = (
            d
        )
        return (
            document_parts_list_post_request_data_item_relationships_work_item
