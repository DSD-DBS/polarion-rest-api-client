...
class UsersListPostRequestDataItemAttributesDescription:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        users_list_post_request_data_item_attributes_description = cls(
            type=type,
            value=value,
        )

        users_list_post_request_data_item_attributes_description.additional_properties = (
            d
        )
        return users_list_post_request_data_item_attributes_description
