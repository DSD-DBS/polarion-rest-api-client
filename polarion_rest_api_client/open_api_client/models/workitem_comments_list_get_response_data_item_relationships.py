...
class WorkitemCommentsListGetResponseDataItemRelationships:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        workitem_comments_list_get_response_data_item_relationships = cls(
            author=author,
        ...
        workitem_comments_list_get_response_data_item_relationships.additional_properties = (
            d
        )
        return workitem_comments_list_get_response_data_item_relationships
