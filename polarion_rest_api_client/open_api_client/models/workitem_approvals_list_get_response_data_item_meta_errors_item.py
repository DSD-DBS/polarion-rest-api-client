...
class WorkitemApprovalsListGetResponseDataItemMetaErrorsItem:
    ...
    source: Union[
        Unset, "WorkitemApprovalsListGetResponseDataItemMetaErrorsItemSource"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        workitem_approvals_list_get_response_data_item_meta_errors_item_obj.additional_properties = (
            d
        )
        return (
            workitem_approvals_list_get_response_data_item_meta_errors_item_obj
