...
class WorkitemAttachmentsSingleGetResponseDataMetaErrorsItemSource:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        workitem_attachments_single_get_response_data_meta_errors_item_source = cls(
            pointer=pointer,
            parameter=parameter,
        )

        workitem_attachments_single_get_response_data_meta_errors_item_source.additional_properties = (
            d
        )
        return workitem_attachments_single_get_response_data_meta_errors_item_source
