...
class UsersSinglePatchRequestDataRelationshipsProjectRolesDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = UsersSinglePatchRequestDataRelationshipsProjectRolesDataItemType(
                _type
            )

        id = d.pop("id", UNSET)

        users_single_patch_request_data_relationships_project_roles_data_item = cls(
            type=type,
            id=id,
        )

        users_single_patch_request_data_relationships_project_roles_data_item.additional_properties = (
            d
        )
        return users_single_patch_request_data_relationships_project_roles_data_item
