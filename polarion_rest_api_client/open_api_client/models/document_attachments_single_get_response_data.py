...
class DocumentAttachmentsSingleGetResponseData:
    """
    Attributes:
        type (Union[Unset, DocumentAttachmentsSingleGetResponseDataType]):
    ...
    type: Union[Unset, DocumentAttachmentsSingleGetResponseDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        document_attachments_single_get_response_data = cls(
            type=type,
            id=id,
            revision=revision,
        ...
        document_attachments_single_get_response_data.additional_properties = d
        return document_attachments_single_get_response_data
