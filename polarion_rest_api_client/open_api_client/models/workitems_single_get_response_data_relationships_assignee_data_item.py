...
class WorkitemsSingleGetResponseDataRelationshipsAssigneeDataItem:
    """
    Attributes:
        type (Union[Unset, WorkitemsSingleGetResponseDataRelationshipsAssigneeDataItemType]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = WorkitemsSingleGetResponseDataRelationshipsAssigneeDataItemType(
                _type
            )
        ...
        workitems_single_get_response_data_relationships_assignee_data_item = (
            cls(
                type=type,
                id=id,
                revision=revision,
        ...
        workitems_single_get_response_data_relationships_assignee_data_item.additional_properties = (
            d
        )
        return (
            workitems_single_get_response_data_relationships_assignee_data_item
