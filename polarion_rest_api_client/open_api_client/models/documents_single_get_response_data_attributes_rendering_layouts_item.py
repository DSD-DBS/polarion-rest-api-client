...
class DocumentsSingleGetResponseDataAttributesRenderingLayoutsItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        documents_single_get_response_data_attributes_rendering_layouts_item = cls(
            type=type,
            label=label,
            layouter=layouter,
        ...
        documents_single_get_response_data_attributes_rendering_layouts_item.additional_properties = (
            d
        )
        return documents_single_get_response_data_attributes_rendering_layouts_item
