...
class CollectionsSingleGetResponseDataRelationshipsReusedFromData:
    ...
    Attributes:
        ...
        type (Union[Unset, CollectionsSingleGetResponseDataRelationshipsReusedFromDataType]):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = CollectionsSingleGetResponseDataRelationshipsReusedFromDataType(
                _type
            )
        ...
        collections_single_get_response_data_relationships_reused_from_data_obj.additional_properties = (
            d
        )
