...
class WorkitemApprovalsSingleGetResponseDataMetaErrorsItem:
    ...
    source: Union[
        Unset, "WorkitemApprovalsSingleGetResponseDataMetaErrorsItemSource"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        workitem_approvals_single_get_response_data_meta_errors_item_obj.additional_properties = (
            d
        )
