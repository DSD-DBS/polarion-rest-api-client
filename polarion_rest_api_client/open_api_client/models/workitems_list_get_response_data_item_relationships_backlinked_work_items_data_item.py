...
class WorkitemsListGetResponseDataItemRelationshipsBacklinkedWorkItemsDataItem:
    ...
    Attributes:
        ...
        type_ (Union[Unset, WorkitemsListGetResponseDataItemRelationshipsBacklinkedWorkItemsDataItemType]):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_list_get_response_data_item_relationships_backlinked_work_items_data_item_obj.additional_properties = (
            d
        )
