...
class WorkitemCommentsSinglePatchRequestData:
    """
    Attributes:
        type_ (Union[Unset, WorkitemCommentsSinglePatchRequestDataType]):
    ...
    type_: Union[Unset, WorkitemCommentsSinglePatchRequestDataType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitem_comments_single_patch_request_data_obj.additional_properties = (
            d
        )
