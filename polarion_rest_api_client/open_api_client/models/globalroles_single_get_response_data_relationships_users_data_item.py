...
class GlobalrolesSingleGetResponseDataRelationshipsUsersDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        globalroles_single_get_response_data_relationships_users_data_item = (
            cls(
                type=type,
                id=id,
            )
        ...
        globalroles_single_get_response_data_relationships_users_data_item.additional_properties = (
            d
        )
        return (
            globalroles_single_get_response_data_relationships_users_data_item
