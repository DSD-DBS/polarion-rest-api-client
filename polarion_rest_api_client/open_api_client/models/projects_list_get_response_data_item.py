...
class ProjectsListGetResponseDataItem:
    ...
    attributes: Union[
        Unset, "ProjectsListGetResponseDataItemAttributes"
    ] = UNSET
    relationships: Union[
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projects_list_get_response_data_item = cls(
            type=type,
            id=id,
            revision=revision,
        ...
        projects_list_get_response_data_item.additional_properties = d
        return projects_list_get_response_data_item
