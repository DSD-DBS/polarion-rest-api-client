...
class ProjectsSingleGetResponseDataMetaErrorsItemSource:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projects_single_get_response_data_meta_errors_item_source = cls(
            pointer=pointer,
            parameter=parameter,
        )

        projects_single_get_response_data_meta_errors_item_source.additional_properties = (
            d
        )
        return projects_single_get_response_data_meta_errors_item_source
