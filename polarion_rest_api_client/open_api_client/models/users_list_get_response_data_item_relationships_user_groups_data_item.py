...
class UsersListGetResponseDataItemRelationshipsUserGroupsDataItem:
    """
    Attributes:
        type (Union[Unset, UsersListGetResponseDataItemRelationshipsUserGroupsDataItemType]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = UsersListGetResponseDataItemRelationshipsUserGroupsDataItemType(
                _type
            )
        ...
        users_list_get_response_data_item_relationships_user_groups_data_item = cls(
            type=type,
            id=id,
            revision=revision,
        )

        users_list_get_response_data_item_relationships_user_groups_data_item.additional_properties = (
            d
        )
        return users_list_get_response_data_item_relationships_user_groups_data_item
