...
class EnumerationsSingleGetResponseDataMetaErrorsItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        enumerations_single_get_response_data_meta_errors_item = cls(
            status=status,
            title=title,
            detail=detail,
            source=source,
        ...
        enumerations_single_get_response_data_meta_errors_item.additional_properties = (
            d
        )
        return enumerations_single_get_response_data_meta_errors_item
