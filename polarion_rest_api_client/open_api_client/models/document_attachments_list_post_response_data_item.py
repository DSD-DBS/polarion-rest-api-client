...
class DocumentAttachmentsListPostResponseDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        document_attachments_list_post_response_data_item = cls(
            type=type,
            id=id,
            links=links,
        )

        document_attachments_list_post_response_data_item.additional_properties = (
            d
        )
        return document_attachments_list_post_response_data_item
