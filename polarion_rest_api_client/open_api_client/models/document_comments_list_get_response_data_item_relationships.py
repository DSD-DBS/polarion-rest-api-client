...
class DocumentCommentsListGetResponseDataItemRelationships:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        document_comments_list_get_response_data_item_relationships = cls(
            author=author,
        ...
        document_comments_list_get_response_data_item_relationships.additional_properties = (
            d
        )
        return document_comments_list_get_response_data_item_relationships
