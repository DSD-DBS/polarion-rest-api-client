...
class DocumentAttachmentsListPostResponse:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        document_attachments_list_post_response = cls(
            data=data,
        )

        document_attachments_list_post_response.additional_properties = d
        return document_attachments_list_post_response
