...
class EnumerationsSingleGetResponseDataAttributesOptionsItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        enumerations_single_get_response_data_attributes_options_item = cls(
            id=id,
            name=name,
            color=color,
        ...
        enumerations_single_get_response_data_attributes_options_item.additional_properties = (
            d
        )
        return enumerations_single_get_response_data_attributes_options_item
