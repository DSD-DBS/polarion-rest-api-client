...
class DocumentCommentsSingleGetResponseDataRelationships:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        document_comments_single_get_response_data_relationships = cls(
            author=author,
        ...
        document_comments_single_get_response_data_relationships.additional_properties = (
            d
        )
        return document_comments_single_get_response_data_relationships
