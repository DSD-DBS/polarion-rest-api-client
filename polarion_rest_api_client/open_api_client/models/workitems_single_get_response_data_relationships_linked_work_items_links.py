...
class WorkitemsSingleGetResponseDataRelationshipsLinkedWorkItemsLinks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        workitems_single_get_response_data_relationships_linked_work_items_links = cls(
            related=related,
        )

        workitems_single_get_response_data_relationships_linked_work_items_links.additional_properties = (
            d
        )
        return workitems_single_get_response_data_relationships_linked_work_items_links
