...
class DocumentAttachmentsListGetResponseDataItemLinks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        document_attachments_list_get_response_data_item_links = cls(
            self_=self_,
            content=content,
        )

        document_attachments_list_get_response_data_item_links.additional_properties = (
            d
        )
        return document_attachments_list_get_response_data_item_links
