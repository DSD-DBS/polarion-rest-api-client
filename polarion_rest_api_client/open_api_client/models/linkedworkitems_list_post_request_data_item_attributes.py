...
class LinkedworkitemsListPostRequestDataItemAttributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        linkedworkitems_list_post_request_data_item_attributes = cls(
            revision=revision,
            role=role,
            suspect=suspect,
        )

        linkedworkitems_list_post_request_data_item_attributes.additional_properties = (
            d
        )
        return linkedworkitems_list_post_request_data_item_attributes
