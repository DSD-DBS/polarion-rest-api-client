...
class DocumentAttachmentsListGetResponseLinks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        document_attachments_list_get_response_links = cls(
            self_=self_,
            first=first,
            prev=prev,
            next_=next_,
        ...
        document_attachments_list_get_response_links.additional_properties = d
        return document_attachments_list_get_response_links
