...
class TestrunsListGetResponseDataItemRelationshipsDocumentData:
    ...
    Attributes:
        ...
        type_ (Union[Unset, TestrunsListGetResponseDataItemRelationshipsDocumentDataType]):
    """

    id: Union[Unset, str] = UNSET
    revision: Union[Unset, str] = UNSET
    type_: Union[
        Unset, TestrunsListGetResponseDataItemRelationshipsDocumentDataType
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testruns_list_get_response_data_item_relationships_document_data_obj.additional_properties = (
            d
        )
