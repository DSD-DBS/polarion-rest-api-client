...
class TestrunCommentsListPostRequestDataItemAttributesText:
    """
    Attributes:
        type_ (Union[Unset, TestrunCommentsListPostRequestDataItemAttributesTextType]):
        value (Union[Unset, str]):  Example: My text value.
    """

    type_: Union[
        Unset, TestrunCommentsListPostRequestDataItemAttributesTextType
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrun_comments_list_post_request_data_item_attributes_text_obj.additional_properties = (
            d
        )
