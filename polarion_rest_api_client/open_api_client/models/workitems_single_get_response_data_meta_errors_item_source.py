...
class WorkitemsSingleGetResponseDataMetaErrorsItemSource:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        workitems_single_get_response_data_meta_errors_item_source = cls(
            pointer=pointer,
            parameter=parameter,
        )

        workitems_single_get_response_data_meta_errors_item_source.additional_properties = (
            d
        )
        return workitems_single_get_response_data_meta_errors_item_source
