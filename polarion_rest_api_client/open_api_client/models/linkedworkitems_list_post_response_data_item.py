...
class LinkedworkitemsListPostResponseDataItem:
    """
    Attributes:
        type (Union[Unset, LinkedworkitemsListPostResponseDataItemType]):
    ...
    type: Union[Unset, LinkedworkitemsListPostResponseDataItemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = LinkedworkitemsListPostResponseDataItemType(_type)
        ...
        linkedworkitems_list_post_response_data_item = cls(
            type=type,
            id=id,
            links=links,
        )

        linkedworkitems_list_post_response_data_item.additional_properties = d
        return linkedworkitems_list_post_response_data_item
