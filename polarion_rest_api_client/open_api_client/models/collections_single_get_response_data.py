...
class CollectionsSingleGetResponseData:
    """
    Attributes:
        type (Union[Unset, CollectionsSingleGetResponseDataType]):
    ...
    type: Union[Unset, CollectionsSingleGetResponseDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = CollectionsSingleGetResponseDataType(_type)
