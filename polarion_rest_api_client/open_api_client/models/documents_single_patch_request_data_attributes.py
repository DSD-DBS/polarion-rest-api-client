...
class DocumentsSinglePatchRequestDataAttributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        documents_single_patch_request_data_attributes = cls(
        ...
        documents_single_patch_request_data_attributes.additional_properties = (
            d
        )
        return documents_single_patch_request_data_attributes
