...
To update the auto generated part of the code, execute the `build_client_source.sh` script with `path` or `url` as first
arg and the path to the OpenAPI-Specification as second arg. For Copyright reasons, we don't publish the Specification here,
