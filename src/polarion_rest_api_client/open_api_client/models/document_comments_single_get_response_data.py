...
class DocumentCommentsSingleGetResponseData:
    ...
    type: Unset | DocumentCommentsSingleGetResponseDataType = UNSET
    id: Unset | str = UNSET
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | DocumentCommentsSingleGetResponseDataType
        ...
        attributes: Unset | DocumentCommentsSingleGetResponseDataAttributes
        ...
        links: Unset | DocumentCommentsSingleGetResponseDataLinks
        ...
        meta: Unset | DocumentCommentsSingleGetResponseDataMeta
