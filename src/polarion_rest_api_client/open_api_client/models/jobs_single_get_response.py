...
class JobsSingleGetResponse:
    """Attributes data (Union[Unset, JobsSingleGetResponseData]):
    ...
    included: Unset | list["JobsSingleGetResponseIncludedItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        data: Unset | JobsSingleGetResponseData
        ...
        links: Unset | JobsSingleGetResponseLinks
