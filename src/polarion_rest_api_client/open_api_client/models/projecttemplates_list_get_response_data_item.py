...
class ProjecttemplatesListGetResponseDataItem:
    ...
    type: Unset | ProjecttemplatesListGetResponseDataItemType = UNSET
    id: Unset | str = UNSET
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | ProjecttemplatesListGetResponseDataItemType
        ...
        attributes: Unset | ProjecttemplatesListGetResponseDataItemAttributes
        ...
        links: Unset | ProjecttemplatesListGetResponseDataItemLinks
        ...
        meta: Unset | ProjecttemplatesListGetResponseDataItemMeta
