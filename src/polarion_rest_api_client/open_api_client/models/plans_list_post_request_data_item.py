...
class PlansListPostRequestDataItem:
    ...
    type: Unset | PlansListPostRequestDataItemType = UNSET
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | PlansListPostRequestDataItemType
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = PlansListPostRequestDataItemType(_type)

        _attributes = d.pop("attributes", UNSET)
        attributes: Unset | PlansListPostRequestDataItemAttributes
        ...
        relationships: Unset | PlansListPostRequestDataItemRelationships
