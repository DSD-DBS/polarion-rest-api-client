...
class LinkedworkitemsListPostRequestDataItem:
    ...
    type: Unset | LinkedworkitemsListPostRequestDataItemType = UNSET
    attributes: Union[
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | LinkedworkitemsListPostRequestDataItemType
        ...
        attributes: Unset | LinkedworkitemsListPostRequestDataItemAttributes
