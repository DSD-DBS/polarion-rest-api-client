...
class TestrecordAttachmentsSinglePatchRequestData:
    ...
    type: Union[Unset, TestrecordAttachmentsSinglePatchRequestDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = TestrecordAttachmentsSinglePatchRequestDataType(_type)
        ...
        testrecord_attachments_single_patch_request_data_obj.additional_properties = (
            d
        )
