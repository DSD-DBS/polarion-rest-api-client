...
class TestrunCommentsListGetResponseDataItemAttributes:
    ...
    text (Union[Unset, TestrunCommentsListGetResponseDataItemAttributesText]):
    ...
    text: Union[
        Unset, "TestrunCommentsListGetResponseDataItemAttributesText"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        text: Unset | TestrunCommentsListGetResponseDataItemAttributesText
