...
class DocumentsSingleGetResponseDataAttributes:
    ...
    auto_suspect: Unset | bool = UNSET
    branched_with_initialized_fields: Unset | list[str] = UNSET
    branched_with_query: Unset | str = UNSET
    created: Unset | datetime.datetime = UNSET
    derived_fields: Unset | list[str] = UNSET
    derived_from_link_role: Unset | str = UNSET
    home_page_content: Union[
        Unset, "DocumentsSingleGetResponseDataAttributesHomePageContent"
    ] = UNSET
    module_folder: Unset | str = UNSET
    module_name: Unset | str = UNSET
    ...
    uses_outline_numbering: Unset | bool = UNSET
