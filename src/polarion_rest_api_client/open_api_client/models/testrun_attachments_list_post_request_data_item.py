...
class TestrunAttachmentsListPostRequestDataItem:
    ...
    type: Unset | TestrunAttachmentsListPostRequestDataItemType = UNSET
    attributes: Union[
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | TestrunAttachmentsListPostRequestDataItemType
        ...
        attributes: Unset | TestrunAttachmentsListPostRequestDataItemAttributes
