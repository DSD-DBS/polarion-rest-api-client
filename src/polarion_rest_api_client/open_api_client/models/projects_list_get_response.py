...
class ProjectsListGetResponse:
    """Attributes data (Union[Unset, List['ProjectsListGetResponseDataItem']]):
    ...
    data: Unset | list["ProjectsListGetResponseDataItem"] = UNSET
    included: Unset | list["ProjectsListGetResponseIncludedItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        links: Unset | ProjectsListGetResponseLinks
        ...
        meta: Unset | ProjectsListGetResponseMeta
