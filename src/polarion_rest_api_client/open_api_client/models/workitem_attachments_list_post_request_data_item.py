...
class WorkitemAttachmentsListPostRequestDataItem:
    ...
    type: Unset | WorkitemAttachmentsListPostRequestDataItemType = UNSET
    attributes: Union[
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | WorkitemAttachmentsListPostRequestDataItemType
        ...
        attributes: Unset | WorkitemAttachmentsListPostRequestDataItemAttributes
