...
class ProjectsListGetResponseDataItemMetaErrorsItem:
    ...
    source (Union[Unset, ProjectsListGetResponseDataItemMetaErrorsItemSource]):
    ...
    source: Union[
        Unset, "ProjectsListGetResponseDataItemMetaErrorsItemSource"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        source: Unset | ProjectsListGetResponseDataItemMetaErrorsItemSource
