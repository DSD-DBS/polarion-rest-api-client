...
class TestparametersSingleGetResponseData:
    ...
    type: Unset | TestparametersSingleGetResponseDataType = UNSET
    id: Unset | str = UNSET
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | TestparametersSingleGetResponseDataType
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = TestparametersSingleGetResponseDataType(_type)
        ...
        attributes: Unset | TestparametersSingleGetResponseDataAttributes
        ...
        relationships: Unset | TestparametersSingleGetResponseDataRelationships
        ...
        links: Unset | TestparametersSingleGetResponseDataLinks
        ...
        meta: Unset | TestparametersSingleGetResponseDataMeta
