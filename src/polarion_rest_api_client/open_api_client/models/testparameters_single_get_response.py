...
class TestparametersSingleGetResponse:
    """Attributes data (Union[Unset, TestparametersSingleGetResponseData]):
    ...
    included: Unset | list["TestparametersSingleGetResponseIncludedItem"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        data: Unset | TestparametersSingleGetResponseData
        ...
        links: Unset | TestparametersSingleGetResponseLinks
