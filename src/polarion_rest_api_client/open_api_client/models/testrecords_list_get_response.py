...
class TestrecordsListGetResponse:
    ...
    List['TestrecordsListGetResponseDataItem']]):
    ...
    data: Unset | list["TestrecordsListGetResponseDataItem"] = UNSET
    included: Unset | list["TestrecordsListGetResponseIncludedItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        links: Unset | TestrecordsListGetResponseLinks
        ...
        meta: Unset | TestrecordsListGetResponseMeta
