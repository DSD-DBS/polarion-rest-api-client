...
class PlansListGetResponseDataItemAttributes:
    ...
    calculation_type: Unset | PlansListGetResponseDataItemAttributesCalculationType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        calculation_type: Unset | PlansListGetResponseDataItemAttributesCalculationType
        ...
        description: Unset | PlansListGetResponseDataItemAttributesDescription
        ...
        home_page_content: Unset | PlansListGetResponseDataItemAttributesHomePageContent
