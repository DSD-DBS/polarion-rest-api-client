...
class UsergroupsSingleGetResponse:
    """Attributes data (Union[Unset, UsergroupsSingleGetResponseData]):
    ...
    included: Unset | list["UsergroupsSingleGetResponseIncludedItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        data: Unset | UsergroupsSingleGetResponseData
        ...
        for included_item_data in _included or []:
            included_item = UsergroupsSingleGetResponseIncludedItem.from_dict(
                included_item_data
            )
        ...
        links: Unset | UsergroupsSingleGetResponseLinks
