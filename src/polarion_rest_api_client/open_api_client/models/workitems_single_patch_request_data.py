...
class WorkitemsSinglePatchRequestData:
    ...
    type: Unset | WorkitemsSinglePatchRequestDataType = UNSET
    id: Unset | str = UNSET
    attributes: Union[Unset, "WorkitemsSinglePatchRequestDataAttributes"] = (
        UNSET
    )
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | WorkitemsSinglePatchRequestDataType
        ...
        attributes: Unset | WorkitemsSinglePatchRequestDataAttributes
        ...
        relationships: Unset | WorkitemsSinglePatchRequestDataRelationships
