...
class UsersListGetResponse:
    """Attributes data (Union[Unset, List['UsersListGetResponseDataItem']]):
    ...
    data: Unset | list["UsersListGetResponseDataItem"] = UNSET
    included: Unset | list["UsersListGetResponseIncludedItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = UsersListGetResponseDataItem.from_dict(data_item_data)
        ...
        links: Unset | UsersListGetResponseLinks
        ...
        meta: Unset | UsersListGetResponseMeta
