...
class DocumentAttachmentsListPostResponseDataItem:
    ...
    type: Unset | DocumentAttachmentsListPostResponseDataItemType = UNSET
    id: Unset | str = UNSET
    links: Union[Unset, "DocumentAttachmentsListPostResponseDataItemLinks"] = (
        UNSET
    )
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | DocumentAttachmentsListPostResponseDataItemType
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = DocumentAttachmentsListPostResponseDataItemType(_type)

        id = d.pop("id", UNSET)

        _links = d.pop("links", UNSET)
        links: Unset | DocumentAttachmentsListPostResponseDataItemLinks
