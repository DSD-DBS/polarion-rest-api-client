...
class TestparametersListGetResponse:
    ...
    List['TestparametersListGetResponseDataItem']]):
    ...
    data: Unset | list["TestparametersListGetResponseDataItem"] = UNSET
    included: Unset | list["TestparametersListGetResponseIncludedItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        links: Unset | TestparametersListGetResponseLinks
        ...
        meta: Unset | TestparametersListGetResponseMeta
