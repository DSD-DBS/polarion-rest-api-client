...
class PlansListGetResponse:
    """Attributes data (Union[Unset, List['PlansListGetResponseDataItem']]):
    ...
    data: Unset | list["PlansListGetResponseDataItem"] = UNSET
    included: Unset | list["PlansListGetResponseIncludedItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        links: Unset | PlansListGetResponseLinks
        ...
        meta: Unset | PlansListGetResponseMeta
