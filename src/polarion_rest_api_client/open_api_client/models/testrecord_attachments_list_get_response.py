...
class TestrecordAttachmentsListGetResponse:
    ...
    data: Unset | list["TestrecordAttachmentsListGetResponseDataItem"] = UNSET
    included: Unset | list["TestrecordAttachmentsListGetResponseIncludedItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        links: Unset | TestrecordAttachmentsListGetResponseLinks
        ...
        meta: Unset | TestrecordAttachmentsListGetResponseMeta
