...
class ProjectsListGetResponseDataItemRelationshipsLeadData:
    ...
    type: Unset | ProjectsListGetResponseDataItemRelationshipsLeadDataType = UNSET
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | ProjectsListGetResponseDataItemRelationshipsLeadDataType
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = ProjectsListGetResponseDataItemRelationshipsLeadDataType(
                _type
            )
