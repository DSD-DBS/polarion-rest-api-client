...
class WorkitemAttachmentsSingleGetResponseData:
    ...
    type: Unset | WorkitemAttachmentsSingleGetResponseDataType = UNSET
    id: Unset | str = UNSET
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | WorkitemAttachmentsSingleGetResponseDataType
        ...
        attributes: Unset | WorkitemAttachmentsSingleGetResponseDataAttributes
        ...
        links: Unset | WorkitemAttachmentsSingleGetResponseDataLinks
        ...
        meta: Unset | WorkitemAttachmentsSingleGetResponseDataMeta
