...
class TestrecordsSingleGetResponse:
    """Attributes data (Union[Unset, TestrecordsSingleGetResponseData]):
    ...
    included: Unset | list["TestrecordsSingleGetResponseIncludedItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        data: Unset | TestrecordsSingleGetResponseData
        ...
        links: Unset | TestrecordsSingleGetResponseLinks
