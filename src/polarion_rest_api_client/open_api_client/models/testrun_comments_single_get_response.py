...
class TestrunCommentsSingleGetResponse:
    """Attributes data (Union[Unset, TestrunCommentsSingleGetResponseData]):
    ...
    included: Unset | list["TestrunCommentsSingleGetResponseIncludedItem"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        data: Unset | TestrunCommentsSingleGetResponseData
        ...
        links: Unset | TestrunCommentsSingleGetResponseLinks
