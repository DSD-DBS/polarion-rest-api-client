...
class WorkitemAttachmentsSinglePatchRequestData:
    ...
    type: Unset | WorkitemAttachmentsSinglePatchRequestDataType = UNSET
    id: Unset | str = UNSET
    attributes: Union[
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | WorkitemAttachmentsSinglePatchRequestDataType
        ...
        attributes: Unset | WorkitemAttachmentsSinglePatchRequestDataAttributes
