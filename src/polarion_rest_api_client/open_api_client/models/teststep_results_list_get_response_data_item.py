...
class TeststepResultsListGetResponseDataItem:
    ...
    type: Unset | TeststepResultsListGetResponseDataItemType = UNSET
    id: Unset | str = UNSET
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | TeststepResultsListGetResponseDataItemType
        ...
        attributes: Unset | TeststepResultsListGetResponseDataItemAttributes
        ...
        links: Unset | TeststepResultsListGetResponseDataItemLinks
        ...
        meta: Unset | TeststepResultsListGetResponseDataItemMeta
