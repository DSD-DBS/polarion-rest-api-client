...
class IconsListGetResponse:
    ...
    included (Union[Unset, List['IconsListGetResponseIncludedItem']]): Related entities might be returned, see <a
        ...
        Guide</a>.
    links (Union[Unset, IconsListGetResponseLinks]):
    meta (Union[Unset, IconsListGetResponseMeta]):
    """

    data: Unset | list["IconsListGetResponseDataItem"] = UNSET
    included: Unset | list["IconsListGetResponseIncludedItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = IconsListGetResponseDataItem.from_dict(data_item_data)
        ...
        links: Unset | IconsListGetResponseLinks
        ...
        meta: Unset | IconsListGetResponseMeta
