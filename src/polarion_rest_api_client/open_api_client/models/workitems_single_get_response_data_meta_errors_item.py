...
class WorkitemsSingleGetResponseDataMetaErrorsItem:
    ...
    source (Union[Unset, WorkitemsSingleGetResponseDataMetaErrorsItemSource]):
    ...
    source: Union[
        Unset, "WorkitemsSingleGetResponseDataMetaErrorsItemSource"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        source: Unset | WorkitemsSingleGetResponseDataMetaErrorsItemSource
