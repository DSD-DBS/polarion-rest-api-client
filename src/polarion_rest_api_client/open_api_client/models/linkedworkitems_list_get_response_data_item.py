...
class LinkedworkitemsListGetResponseDataItem:
    ...
    type: Unset | LinkedworkitemsListGetResponseDataItemType = UNSET
    id: Unset | str = UNSET
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | LinkedworkitemsListGetResponseDataItemType
        ...
        attributes: Unset | LinkedworkitemsListGetResponseDataItemAttributes
        ...
        links: Unset | LinkedworkitemsListGetResponseDataItemLinks
        ...
        meta: Unset | LinkedworkitemsListGetResponseDataItemMeta
