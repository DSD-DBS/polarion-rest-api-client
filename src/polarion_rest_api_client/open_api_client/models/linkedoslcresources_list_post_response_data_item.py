...
class LinkedoslcresourcesListPostResponseDataItem:
    ...
    type: Unset | LinkedoslcresourcesListPostResponseDataItemType = UNSET
    id: Unset | str = UNSET
    links: Union[Unset, "LinkedoslcresourcesListPostResponseDataItemLinks"] = (
        UNSET
    )
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | LinkedoslcresourcesListPostResponseDataItemType
        ...
        links: Unset | LinkedoslcresourcesListPostResponseDataItemLinks
