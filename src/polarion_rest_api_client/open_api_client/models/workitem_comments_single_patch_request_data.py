...
class WorkitemCommentsSinglePatchRequestData:
    ...
    type: Unset | WorkitemCommentsSinglePatchRequestDataType = UNSET
    id: Unset | str = UNSET
    attributes: Union[
        Unset, "WorkitemCommentsSinglePatchRequestDataAttributes"
    ] = UNSET
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | WorkitemCommentsSinglePatchRequestDataType
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = WorkitemCommentsSinglePatchRequestDataType(_type)

        id = d.pop("id", UNSET)

        _attributes = d.pop("attributes", UNSET)
        attributes: Unset | WorkitemCommentsSinglePatchRequestDataAttributes
