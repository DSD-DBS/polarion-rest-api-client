...
class TestrunCommentsSingleGetResponseData:
    ...
    relationships (Union[Unset, TestrunCommentsSingleGetResponseDataRelationships]):
    links (Union[Unset, TestrunCommentsSingleGetResponseDataLinks]):
    meta (Union[Unset, TestrunCommentsSingleGetResponseDataMeta]):
    """

    type: Unset | TestrunCommentsSingleGetResponseDataType = UNSET
    id: Unset | str = UNSET
    revision: Unset | str = UNSET
    attributes: Union[
        Unset, "TestrunCommentsSingleGetResponseDataAttributes"
    ] = UNSET
    relationships: Union[
        Unset, "TestrunCommentsSingleGetResponseDataRelationships"
    ] = UNSET
    links: Union[Unset, "TestrunCommentsSingleGetResponseDataLinks"] = UNSET
    meta: Union[Unset, "TestrunCommentsSingleGetResponseDataMeta"] = UNSET
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | TestrunCommentsSingleGetResponseDataType
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = TestrunCommentsSingleGetResponseDataType(_type)
        ...
        attributes: Unset | TestrunCommentsSingleGetResponseDataAttributes
        ...
        links: Unset | TestrunCommentsSingleGetResponseDataLinks
        ...
        meta: Unset | TestrunCommentsSingleGetResponseDataMeta
