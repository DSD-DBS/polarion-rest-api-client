...
class TestrunAttachmentsSinglePatchRequestData:
    ...
    type: Unset | TestrunAttachmentsSinglePatchRequestDataType = UNSET
    id: Unset | str = UNSET
    attributes: Union[
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | TestrunAttachmentsSinglePatchRequestDataType
        ...
        attributes: Unset | TestrunAttachmentsSinglePatchRequestDataAttributes
