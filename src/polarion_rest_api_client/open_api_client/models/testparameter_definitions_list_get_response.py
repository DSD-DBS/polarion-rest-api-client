...
class TestparameterDefinitionsListGetResponse:
    ...
    data: Unset | list["TestparameterDefinitionsListGetResponseDataItem"] = UNSET
    included: Unset | list["TestparameterDefinitionsListGetResponseIncludedItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        links: Unset | TestparameterDefinitionsListGetResponseLinks
        ...
        meta: Unset | TestparameterDefinitionsListGetResponseMeta
