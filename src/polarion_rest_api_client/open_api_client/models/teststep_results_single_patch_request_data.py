...
class TeststepResultsSinglePatchRequestData:
    ...
    type: Unset | TeststepResultsSinglePatchRequestDataType = UNSET
    id: Unset | str = UNSET
    attributes: Union[
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | TeststepResultsSinglePatchRequestDataType
        ...
        attributes: Unset | TeststepResultsSinglePatchRequestDataAttributes
