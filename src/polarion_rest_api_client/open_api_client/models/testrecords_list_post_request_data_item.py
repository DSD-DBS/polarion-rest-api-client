...
class TestrecordsListPostRequestDataItem:
    ...
    TestrecordsListPostRequestDataItemAttributes]): relationships
    (Union[Unset, TestrecordsListPostRequestDataItemRelationships]):
    """

    type: Unset | TestrecordsListPostRequestDataItemType = UNSET
    attributes: Union[
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | TestrecordsListPostRequestDataItemType
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = TestrecordsListPostRequestDataItemType(_type)

        _attributes = d.pop("attributes", UNSET)
        attributes: Unset | TestrecordsListPostRequestDataItemAttributes
        ...
        relationships: Unset | TestrecordsListPostRequestDataItemRelationships
