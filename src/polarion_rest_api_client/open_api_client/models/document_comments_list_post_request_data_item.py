...
class DocumentCommentsListPostRequestDataItem:
    ...
    type: Unset | DocumentCommentsListPostRequestDataItemType = UNSET
    attributes: Union[
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | DocumentCommentsListPostRequestDataItemType
        ...
        attributes: Unset | DocumentCommentsListPostRequestDataItemAttributes
