...
class RevisionsSingleGetResponseDataRelationshipsAuthorData:
    ...
    type (Union[Unset, RevisionsSingleGetResponseDataRelationshipsAuthorDataType]):
    """

    id: Unset | str = UNSET
    revision: Unset | str = UNSET
    type: Unset | RevisionsSingleGetResponseDataRelationshipsAuthorDataType = UNSET
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | RevisionsSingleGetResponseDataRelationshipsAuthorDataType
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = RevisionsSingleGetResponseDataRelationshipsAuthorDataType(
                _type
            )
