...
class PlansSingleGetResponseDataAttributes:
    ...
    description (Union[Unset, PlansSingleGetResponseDataAttributesDescription]):
    ...
    home_page_content (Union[Unset, PlansSingleGetResponseDataAttributesHomePageContent]):
    ...
    description: Union[
        Unset, "PlansSingleGetResponseDataAttributesDescription"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        description: Unset | PlansSingleGetResponseDataAttributesDescription
