...
class TeststepresultAttachmentsListPostResponseDataItem:
    ...
    type: Unset | TeststepresultAttachmentsListPostResponseDataItemType = UNSET
    id: Unset | str = UNSET
    links: Union[
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | TeststepresultAttachmentsListPostResponseDataItemType
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = TeststepresultAttachmentsListPostResponseDataItemType(_type)

        id = d.pop("id", UNSET)

        _links = d.pop("links", UNSET)
        links: Unset | TeststepresultAttachmentsListPostResponseDataItemLinks
