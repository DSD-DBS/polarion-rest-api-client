...
class TestrunCommentsListGetResponseDataItem:
    ...
    type: Unset | TestrunCommentsListGetResponseDataItemType = UNSET
    id: Unset | str = UNSET
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | TestrunCommentsListGetResponseDataItemType
        ...
        attributes: Unset | TestrunCommentsListGetResponseDataItemAttributes
        ...
        relationships: Unset | TestrunCommentsListGetResponseDataItemRelationships
        ...
        links: Unset | TestrunCommentsListGetResponseDataItemLinks
        ...
        meta: Unset | TestrunCommentsListGetResponseDataItemMeta
