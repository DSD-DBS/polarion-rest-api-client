...
class IconsSingleGetResponse:
    """Attributes data (Union[Unset, IconsSingleGetResponseData]):
    ...
    included: Unset | list["IconsSingleGetResponseIncludedItem"] = UNSET
    links: Union[Unset, "IconsSingleGetResponseLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        data: Unset | IconsSingleGetResponseData
        ...
        links: Unset | IconsSingleGetResponseLinks
