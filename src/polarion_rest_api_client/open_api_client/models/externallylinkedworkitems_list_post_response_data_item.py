...
class ExternallylinkedworkitemsListPostResponseDataItem:
    """Attributes
    type (Union[Unset, ExternallylinkedworkitemsListPostResponseDataItemType]):
    ...
    type: Unset | ExternallylinkedworkitemsListPostResponseDataItemType = UNSET
    id: Unset | str = UNSET
    links: Union[
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | ExternallylinkedworkitemsListPostResponseDataItemType
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = ExternallylinkedworkitemsListPostResponseDataItemType(_type)

        id = d.pop("id", UNSET)

        _links = d.pop("links", UNSET)
        links: Unset | ExternallylinkedworkitemsListPostResponseDataItemLinks
