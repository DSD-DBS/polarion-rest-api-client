...
class WorkitemAttachmentsListPostResponseDataItem:
    ...
    type: Unset | WorkitemAttachmentsListPostResponseDataItemType = UNSET
    id: Unset | str = UNSET
    links: Union[Unset, "WorkitemAttachmentsListPostResponseDataItemLinks"] = (
        UNSET
    )
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | WorkitemAttachmentsListPostResponseDataItemType
        ...
        links: Unset | WorkitemAttachmentsListPostResponseDataItemLinks
