...
class TestrecordsListPatchRequestDataItem:
    """Attributes type (Union[Unset, TestrecordsListPatchRequestDataItemType]):
    ...
    type: Unset | TestrecordsListPatchRequestDataItemType = UNSET
    id: Unset | str = UNSET
    attributes: Union[
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | TestrecordsListPatchRequestDataItemType
        ...
        attributes: Unset | TestrecordsListPatchRequestDataItemAttributes
        ...
        relationships: Unset | TestrecordsListPatchRequestDataItemRelationships
