...
class TeststepsSingleGetResponse:
    """Attributes data (Union[Unset, TeststepsSingleGetResponseData]):
    ...
    included: Unset | list["TeststepsSingleGetResponseIncludedItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        data: Unset | TeststepsSingleGetResponseData
        ...
        links: Unset | TeststepsSingleGetResponseLinks
