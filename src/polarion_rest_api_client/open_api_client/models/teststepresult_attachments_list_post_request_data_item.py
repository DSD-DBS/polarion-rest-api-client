...
class TeststepresultAttachmentsListPostRequestDataItem:
    ...
    type: Unset | TeststepresultAttachmentsListPostRequestDataItemType = UNSET
    attributes: Union[
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | TeststepresultAttachmentsListPostRequestDataItemType
        ...
        attributes: Unset | TeststepresultAttachmentsListPostRequestDataItemAttributes
