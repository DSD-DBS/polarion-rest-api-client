...
class DocumentPartsSingleGetResponseData:
    ...
    type: Unset | DocumentPartsSingleGetResponseDataType = UNSET
    id: Unset | str = UNSET
    revision: Unset | str = UNSET
    attributes: Union[
        Unset, "DocumentPartsSingleGetResponseDataAttributes"
    ] = UNSET
    relationships: Union[
        Unset, "DocumentPartsSingleGetResponseDataRelationships"
    ] = UNSET
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | DocumentPartsSingleGetResponseDataType
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = DocumentPartsSingleGetResponseDataType(_type)
        ...
        attributes: Unset | DocumentPartsSingleGetResponseDataAttributes
        ...
        relationships: Unset | DocumentPartsSingleGetResponseDataRelationships
        ...
        links: Unset | DocumentPartsSingleGetResponseDataLinks
        ...
        meta: Unset | DocumentPartsSingleGetResponseDataMeta
