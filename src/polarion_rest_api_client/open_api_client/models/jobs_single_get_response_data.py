...
class JobsSingleGetResponseData:
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | JobsSingleGetResponseDataType
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = JobsSingleGetResponseDataType(_type)
        ...
        attributes: Unset | JobsSingleGetResponseDataAttributes
        ...
        relationships: Unset | JobsSingleGetResponseDataRelationships
        ...
        links: Unset | JobsSingleGetResponseDataLinks
        ...
        meta: Unset | JobsSingleGetResponseDataMeta
