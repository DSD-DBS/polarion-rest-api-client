...
class TestrecordsListPostRequestDataItemAttributes:
    """
    Attributes:
        comment (Union[Unset, TestrecordsListPostRequestDataItemAttributesComment]):
    ...
    comment: Union[
        Unset, "TestrecordsListPostRequestDataItemAttributesComment"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        testrecords_list_post_request_data_item_attributes_obj.additional_properties = (
            d
        )
