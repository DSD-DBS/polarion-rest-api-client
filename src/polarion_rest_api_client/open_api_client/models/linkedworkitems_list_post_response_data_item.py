...
class LinkedworkitemsListPostResponseDataItem:
    ...
    type: Unset | LinkedworkitemsListPostResponseDataItemType = UNSET
    id: Unset | str = UNSET
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        type: Unset | LinkedworkitemsListPostResponseDataItemType
        ...
        links: Unset | LinkedworkitemsListPostResponseDataItemLinks
